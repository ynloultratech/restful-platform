...
class User
{
     ...
     *
     * @Serializer\Expose()
     * @Serializer\Type("Ynlo\RestfulPlatformBundle\Tests\Fixtures\Model\User")
     */
    protected $manager;
     ...
     *
     * @Serializer\Expose()
     * @Serializer\Type("ArrayCollection<Ynlo\RestfulPlatformBundle\Tests\Fixtures\Model\Group>")
     */
    protected $groups = [];
     ...
     *
     * @Serializer\Expose()
     * @Serializer\Type("ArrayCollection<string,Ynlo\RestfulPlatformBundle\Tests\Fixtures\Model\User>")
     */
    protected $parents = [];
